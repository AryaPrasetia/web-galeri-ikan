...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="index.php"> GALERI FOTO IKAN </a></h1>
        <ul>
            <li><a href="galeriikan.php">Galeri Ikan</a></li>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
				...
				?>
                    <a href="galeriikan.php?kat=<?php echo $k['category_id'] ?>">
                        <div class="col-5">
    ...
    <!-- footer -->
     <footer>
        <div class="container">
            <small>  Galeri Foto Ikan 2024.</small>
        </div>
    </footer>
</body>
</html>